...
class ApplicationTheme {
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
        ...
        titleLarge: TextStyle(fontSize: 13.px, fontWeight: FontWeight.w700),
        ...
        headlineLarge: TextStyle(fontSize: 17.sp, fontWeight: FontWeight.w600),
        headlineMedium: TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w600),
        headlineSmall: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w600),
