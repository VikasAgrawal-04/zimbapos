    ...
    return Scaffold(
      body: OrientationBuilder(
        builder: (context, orientation) =>
            BlocConsumer<OutletRegisterCubit, OutletRegisterState>(
          listener: (context, state) {},
          builder: (context, state) {
            final subscriberCubit = context.read<OutletRegisterCubit>();
            return Row(
              children: [
                        ...
                        children: [
                          ...
                          Center(
                            child: ElevatedButton(
                              ...
                              onPressed: () => subscriberCubit.saveFn(),
                              child: (state is SubscriptionInfoLoading)
                                  ? const Center(
                                      child:
