...
import 'package:server/apis/routes/screen_fn_mapping_routes.dart';
...
import 'package:server/apis/routes/user_screen_function_junction_routes.dart';
...
class Server {
  ...
  Server({required this.context}) {
    ...
    SFMappingRoute(context, router);
    UserSFJunctionRoutes(context, router);
