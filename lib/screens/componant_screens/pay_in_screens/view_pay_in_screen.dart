...
class PayInDetailsScreen extends StatefulWidget {
  final PayInModel item;
  const PayInDetailsScreen({
    super.key,
    required this.item,
  });

  @override
  State<PayInDetailsScreen> createState() => _PayInDetailsScreenState();
}

class _PayInDetailsScreenState extends State<PayInDetailsScreen> {
  //date time format
